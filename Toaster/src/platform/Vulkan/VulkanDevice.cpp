...
#define TST_DEBUG_SHOW_DEVICE_EXTENSIONS_MESSAGE
#define TST_DEBUG_SHOW_DEVICE_COUNT
#define TST_DEBUG_SHOW_DEVICE_INFO
#endif
...
namespace tst {
	...
	void Device::createInstance() {
		...
		appInfo.pApplicationName = "OrbEngine App";
...
#ifdef TST_DEBUG_SHOW_DEVICE_COUNT
...
#ifdef TST_DEBUG_SHOW_DEVICE_INFO
...
#ifdef TST_DEBUG_SHOW_DEVICE_EXTENSIONS_MESSAGE
