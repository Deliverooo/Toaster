...
#define TST_PROFILE_FN() TST_PROFILE_SCP(__FUNCSIG__)
#else
#define TST_PROFILE_BEGIN(name, fp)
#define TST_PROFILE_END()
#define TST_PROFILE_SCP(name)
#define TST_PROFILE_FN()
